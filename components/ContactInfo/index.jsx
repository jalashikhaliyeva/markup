          ...
          <div className="p-4 bg-[#ECEDFE] rounded-2xl">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#514DFB" />
                  <stop offset="1" stopColor="#5945FB" />
                </linearGradient>
              </defs>
            </svg>
          </div>
        ...
        <div className="flex space-x-4 items-center pt-4">
          {socialLinks && socialLinks.length > 0 ? (
            socialLinks.map((social, index) => {
              // Extract the platform name from the link, e.g., 'instagram' from 'instagram.com'
              const platform = social.link.split(".")[0].toLowerCase();

              // Ensure the link has the correct protocol
              const href = social.link.startsWith("http")
                ? social.link
                : `https://${social.link}`;
              ...
              return (
                ...
                >
                  <Image
                    src={social.image} // Use 'thumb_image' if you prefer smaller images for certain screens
                    alt={`${platform} icon`}
